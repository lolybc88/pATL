...
<asm version="1.0" name="0">
	<cp>
		<constant value="CreateManyTraceElements"/>
		...
		<constant value="A.__matchRename():V"/>
		<constant value="__exec__"/>
		<constant value="Rename"/>
		<constant value="NTransientLinkSet;.getLinksByRule(S):QNTransientLink;"/>
		<constant value="A.__applyRename(NTransientLink;):V"/>
		...
		<constant value="__matchRename"/>
		<constant value="Class"/>
		<constant value="SampleUML"/>
		<constant value="IN"/>
		...
		<constant value="11:12-11:18"/>
		<constant value="11:21-11:24"/>
		<constant value="11:12-11:24"/>
		<constant value="11:4-11:24"/>
		<constant value="link"/>
	</cp>
	<field name="1" type="2"/>
	<field name="3" type="4"/>
	...
	<operation name="112">
		...
		<linenumbertable>
			<lne id="123" begin="19" end="33"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="1" name="118" begin="6" end="35"/>
	...
	<operation name="124">
		...
		<linenumbertable>
			...
			<lne id="132" begin="12" end="13"/>
			<lne id="133" begin="14" end="14"/>
			<lne id="134" begin="12" end="15"/>
			<lne id="135" begin="9" end="18"/>
			<lne id="123" begin="8" end="19"/>
		</linenumbertable>
		<localvariabletable>
			<lve slot="3" name="120" begin="7" end="19"/>
			<lve slot="2" name="118" begin="3" end="19"/>
			<lve slot="0" name="26" begin="0" end="19"/>
			<lve slot="1" name="136" begin="0" end="19"/>
		</localvariabletable>
	</operation>
</asm>
