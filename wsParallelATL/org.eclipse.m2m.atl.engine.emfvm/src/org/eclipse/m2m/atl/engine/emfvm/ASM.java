...
public class ASM {
	...
	protected List<ASMOperation> operations = new ArrayList<ASMOperation>();
	...
	protected List<LibExtension> getAllExtensions(Map<String, Object> options) {
	...
	@SuppressWarnings("unchecked")
	protected void addAllTypesExtensions(Map<String, Object> options) {
