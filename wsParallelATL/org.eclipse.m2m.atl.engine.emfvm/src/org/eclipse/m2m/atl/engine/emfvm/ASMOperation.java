...
public class ASMOperation extends Operation {
	...
	protected int nbNestedIterates;
	...
	protected static Class<?>[] getTypesOf(Object[] arguments) {
	 ...
	 */
	protected static String getMethodSignature(String name, Class<?>[] argumentTypes) {
